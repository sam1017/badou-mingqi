...
def main():
    ...
    for epoch in range(epoch_num):
        ...
        print(list(model.state_dict().values())[0])
        print(list(model.state_dict().values())[2])
    return
...
if __name__ == "__main__":
    main()
    # test_strings = ["yevx只e", "hrsdfg", "rqaeqg", "nlcdww"]
