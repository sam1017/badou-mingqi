...
class NgramLanguageModel:
    ...
    def ngram_count(self, corpus):
        ...
        #print(sum(self.ngram_count_dict[1].values()), self.ngram_count_dict[1])
        #print(sum(self.ngram_count_dict[2].values()), self.ngram_count_dict[2])
        #print(sum(self.ngram_count_dict[3].values()), self.ngram_count_dict[3])
        return
        ...
        for window_size in range(1, self.n + 1):
            for ngram, count in self.ngram_count_dict[window_size].items():
                if window_size > 1:
                    ...
                    #print("ngram_splits: ", ngram_splits)
                    ngram_prefix = self.sep.join(ngram_splits[:-1])   #ngram_prefix :a b
                    #print("ngram_prefix: ", ngram_prefix)
                ...
                #print("window_size: ", window_size, " ngram_prefix_count: ", ngram_prefix_count)
                self.ngram_count_prob_dict[window_size][ngram] = count / ngram_prefix_count

        #print(self.ngram_count_prob_dict[1])
        #print(self.ngram_count_prob_dict[2])
        #print(self.ngram_count_prob_dict[3])
        return
    ...
    def calc_sentence_ppl(self, sentence):
        ...
        sentence_prob = 0
        #print("calc_sentence_ppl word_list: ", word_list)
        for index, word in enumerate(word_list):
            ...
            #print("ngram:", ngram, " sentence_prob: ", sentence_prob)
